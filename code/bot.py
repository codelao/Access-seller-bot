...
from config import TOKEN, PUBLIC_CHANNEL_ID, PRIVATE_CHANNEL_ID,  STICKER_ID, CRYPTO_ADDRESS, TRANSACTION_AMOUNT, DISCOUNTED_TRANSACTION_AMOUNT, ACCESS_EXPIRY, ADMIN_ID
